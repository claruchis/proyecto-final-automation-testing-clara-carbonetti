...
class InventoryPage:
    def __init__(self, driver):
        self.driver = driver #esto se hace en cada clase para iniciar el navegador y usarlo
        ...
        #self.primer_precio = (By.CLASS_NAME, "inventory_item_price")
...
#quiero ver si el menú está visible en la página
    def menu_visible(self):
        return self.driver.find_element(*self.menu_button).is_displayed() 
    
#quiero ver si el filtro está visible en la página    
    ...
    def obtener_contador_carrito(self):
        self.driver.find_element(*self.contador_carrito).text
    
    def click_carrito(self):
